...
function _precompile_()
    ...
    precompile(Nettle.call, (Type{Nettle.Decryptor}, Compat.ASCIIString, Array{UInt8, 1},))
    precompile(Nettle.call, (Type{Nettle.HMACState}, Compat.ASCIIString, Array{UInt8, 1},))
    ...
    precompile(Nettle.call, (Type{Nettle.Encryptor}, Compat.ASCIIString, Array{UInt8, 1},))
    ...
    precompile(Nettle.decrypt, (Compat.ASCIIString, Array{UInt8, 1}, Array{UInt8, 1},))
    precompile(Nettle.update!, (Nettle.HMACState, Compat.ASCIIString,))
    precompile(Nettle.encrypt, (Compat.ASCIIString, Array{UInt8, 1}, Array{UInt8, 1},))
