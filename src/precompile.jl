...
function _precompile_()
    ...
    if VERSION >= v"0.6-"
        ...
        precompile(Nettle.HashType, (Nettle.NettleHash, Ptr{Nothing},))
        precompile(Nettle.Encryptor, (String, Vector{UInt8},))
        precompile(Nettle.Hasher, (String,))
        precompile(Nettle.HMACState, (String, String,))
        precompile(Nettle.HashType, (String, UInt32, UInt32, UInt32, Ptr{Nothing}, Ptr{Nothing}, Ptr{Nothing}, Ptr{Nothing},))
        precompile(Nettle.CipherType, (String, UInt32, UInt32, UInt32, Ptr{Nothing}, Ptr{Nothing}, Ptr{Nothing}, Ptr{Nothing},))
    else
        ...
        precompile(Nettle.call, (Type{Nettle.HashType}, Nettle.NettleHash, Ptr{Nothing},))
        ...
        precompile(Nettle.call, (Type{Nettle.HashType}, String, UInt32, UInt32, UInt32, Ptr{Nothing}, Ptr{Nothing}, Ptr{Nothing}, Ptr{Nothing},))
        precompile(Nettle.call, (Type{Nettle.CipherType}, String, UInt32, UInt32, UInt32, Ptr{Nothing}, Ptr{Nothing}, Ptr{Nothing}, Ptr{Nothing},))
    end
